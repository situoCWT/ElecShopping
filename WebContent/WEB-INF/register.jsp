...
<link rel="stylesheet" rev="stylesheet" href="${pageContext.request.contextPath}/css/style.css" type="text/css" media="all" /></link>
...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td><img src="${pageContext.request.contextPath}/images/check_use.gif" width="111" height="24" /></td>
  </tr>
  <tr>
    <td style="text-align:right">会员名：</td>
    <td><input type="text" class="textinput"  name="uname" id="uname"/></td>
    <td><img src="${pageContext.request.contextPath}/images/check_use.gif" width="111" height="24" id="check_name"/><span id="sp"></span></td>
  </tr>
  <tr>
...
<table width="80%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td style="width:30%"><input type="text" class="textinput" name="checknum"/></td>
...
<table width="70%" border="0" cellspacing="0">
  <tr>
    <td><textarea name="textarea" class="textarea" name="agree"></textarea></td>
  </tr>
</table>
