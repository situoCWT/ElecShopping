              ...
              <tr>
                <td><table cellspacing="1" class="carttable">
                  <tr>
                   ...
                   <c:if test="${cartlist.size()==0 }"><font color="red">购物车为空</font></c:if>
                   ...
                   <c:if test="${i.state==0&&i.userid == user.userid }">
						   ...
						   <table width="100%" border="0" cellspacing="0">
		                    <tr>
		                      ...
		                      <td width="10%"><a href="${pageContext.request.contextPath}/cartdel.do?gid=${i.gid}" style="color:#FF0000; font-weight:bold">X</a></td>
		                    </tr>
		                  </table>
				   ...
				   <div style="text-align:right; margin-top:10px"><a href="${pageContext.request.contextPath}/list.do"><img src="${pageContext.request.contextPath}/images/gwc_jx.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/order.do"><img src="images/gwc_buy.gif" border="0" /></a></div>
