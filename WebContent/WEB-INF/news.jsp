...
<div id="divpagecontent">
  <table width="100%" border="0" cellspacing="0">
    <tr>
      ...
      <td><div style="text-align:right; margin:5px 10px 5px 0px"><a href="index.do">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;公告新闻&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;${newslist[id-1].title}</div>
        ...
        <table cellspacing="0" class="infocontent">
          <tr>
            <td><img src="${pageContext.request.contextPath}/images/ad/page_ad.jpg" width="652" height="86" />
              <table width="100%" border="0" cellspacing="0">
                <tr>
                  <td style="padding:10px"><h1>${newslist[id-1].title}</h1>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:8px">${newslist[id-1].tdate}</font>
				  <hr style="color:#006600"/>
				  <p>　　${newslist[id-1].tcontent}</p>
				  </td>
                </tr>
